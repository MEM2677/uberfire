...
public class PlaceManagerImpl
    ...
    @Inject
    private PlaceManagerHelper placeManagerHelper;
    ...
    public PlaceManagerHelper getPlaceManagerHelper() {
        return placeManagerHelper;
    }
...
//            getPlaceManagerHelper().openDock(dockId);
    ...
    private void launchWorkbenchActivityInPanel(final PlaceRequest place,
        ...
        try {
            activity.onOpen();
            // Matteo
            getPlaceManagerHelper().onOpen(activity,
                                           place);
    ...
    private void closePlace(final PlaceRequest place,
        ...
        // matteo
        placeManagerHelper.onClose(activity,
                                   place);
